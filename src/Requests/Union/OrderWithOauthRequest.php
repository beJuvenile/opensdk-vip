 ...
 * 获取订单信息列表
 *
 * @link: http://vop.vip.com/apicenter/method?serviceName=com.vip.adp.api.open.service.UnionOrderService-1.0.0&methodName=orderListWithOauth
 *
 * @brief: 获取订单信息列表. 注：（1）订单归属人为授权用户（2）默认一分钟最多访问60次
 *
...
class OrderWithOauthRequest implements Request
{
     ...
     * @var string
     */
    public $method = 'orderListWithOauth';
