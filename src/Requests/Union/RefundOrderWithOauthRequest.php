 ...
 * 获取维权订单列表，订单归属人为授权用户
 *
 * @link: http://vop.vip.com/apicenter/method?serviceName=com.vip.adp.api.open.service.UnionOrderService-1.0.0&methodName=refundOrderListWithOauth
 *
...
class RefundOrderWithOauthRequest implements Request
{
     ...
     * @var string
     */
    public $method = 'refundOrderListWithOauth';
